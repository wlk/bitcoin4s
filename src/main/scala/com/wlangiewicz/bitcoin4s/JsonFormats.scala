...
trait JsonFormats extends SprayJsonSupport with DefaultJsonProtocol {
  ...
  implicit val SoftforkFormat: RootJsonFormat[Softfork] = jsonFormat8(Softfork)
  ...
  implicit val GetBlockChainInfoFormat: RootJsonFormat[GetBlockChainInfo] = jsonFormat11(GetBlockChainInfo)
}
